...
const CircularQueueVisualizer = () =>{
    ...
    return (
        <div className="p-4 md:p-4 text-cyan-300 flex flex-col items-center">
            <h1 className="text-title text-2xl md:text-4xl font-bold font-serif text-center">Circular Queue using Array Visualizer</h1>
            ...
            <div className="mt-4 flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 w-full max-w-lg">
                ...
                <button onClick={()=>Front==Rear?alert("Queue is Empty"):alert("Rear element is "+list[(Front-1%QueueSize)])} className="px-4 py-2 bg-btn-lnk rounded-lg hover:bg-cyan-400 text-gray-950 w-full md:w-auto">Front </button>
                <button onClick={()=>Front==Rear?alert("Queue is Empty"):alert("Rear element is "+list[Rear])} className="px-4 py-2 bg-btn-lnk rounded-lg hover:bg-cyan-400 text-gray-950 w-full md:w-auto">Rear </button>
