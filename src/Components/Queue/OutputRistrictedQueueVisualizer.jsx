...
const OutputRestrictedQueueVisualizer = () => {
    const QueueSize = 10;
    ...
    // Function to DeQueue (only from the front for Output-Restricted Queue)
    const handleDeQueue = () => {
        if(length == 0){
    ...
    return (
        <div className="p-4 md:p-4 text-cyan-300 flex flex-col items-center">
            <h1 className="text-title text-2xl md:text-4xl font-bold font-serif text-center">Output-Restricted Queue using Array Visualizer</h1>
...
export default OutputRestrictedQueueVisualizer;
